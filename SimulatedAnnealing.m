function SimulatedAnnealing( GAL1_trait, param_init, parameter_update, fit_type, varargin )
...
mcmc_version = 'Simulated_Annealing';
...
while Temperature > Tmin
    for i_propose = 1:n_propose
        ...
        if accept_thre >= 0
            ...
            accept = random('uniform', 0, 1, 1) < exp(accept_thre/Temperature);
        end

classdef Violin < handle
    ...
    properties (Dependent=true)
        ...
        ShowNotches % whether to show notch indicators
        ShowMean    % whether to show mean indicator
        Strain      % hacked by JH, to choose from 'wt', 'mig1d' & 'gal80d'
    end
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            % hack here to separate the violins of different strains
            if strcmp(args.Strain, 'wt')
                pos = pos * 2;
            elseif strcmp(args.Strain, 'gal80d')
                pos = pos * 2 - 0.5;
            elseif strcmp(args.Strain, 'mig1d')
                pos = pos * 2 + 0.5;
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            % hacked by JH, add a property 'Strain'
            p.addParameter('Strain', '', @ischar);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
